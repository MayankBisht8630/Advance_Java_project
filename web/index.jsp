        ...
        <div class="container-fluid-0 m-0  ">
            <div class="jumbotron primary-background text-white banner-background">
                <div class="container">
                    ...
                    <a href="view_all.jsp" class="btn btn-outline-light btn-lg"> <span class=" fa fa-sign-in fa-spin"></span> View All </a>
                    <a href="about.jsp" class="btn btn-outline-light btn-lg"> <span class=" fa fa-user-circle fa-spin"></span> About </a>
                </div>
            </div>
        </div>

        <!--cards-->
        <form action="view_books.jsp">
        <div class ="container">
            <div class="row mb-2">
                <div class="col-md-4 text-center">
                    <div class="card" id="main" style="width: 18rem; height: 600px">
                        ...
                        <div class="card-body">
                            ...
                            <a href="view_books.jsp" class="btn primary-background text-white"> More Details</a>
                        </div>
                    </div>
                </div>
                <div class="col-md-4 text-center">
            ...
            <div class="row">
                ...
                <div class="col-md-4 text-center">
                    <div class="card" id="main" style="width: 18rem; height: 600px">
                        ...
                        <br>
                        <br>
                        <a href="view_books.jsp" onclick="passvalues()" class="btn primary-background text-white">More Details</a>
                        </div>
                    </div>
                </div>
